...
class Policy(object):
    ...
    def update(self, observes, actions, advantages, logger):
        ...
        actions_probs_act = torch.clamp(actions_probs_act, 1e-10, 1)
        actions_probs_old_act = torch.clamp(actions_probs_old_act, 1e-10, 1)
        ratios_act = torch.exp(torch.log(actions_probs_act) - torch.log(actions_probs_old_act)) 
