...
class Policy(object):
    ...
    def prune_policy(self, sparsity = 0.5):
        ...
        self.prune = True
        layer_one = self.policynetwork.fc1
        prune.l1_unstructured(layer_one, name = "weight", amount = sparsity)
    ...
    def prune_remove(self):
        ...
        self.prune = False
        layer_one = self.policynetwork.fc1
        prune.remove(layer_one, name = "weight")
    ...
    def set_weights_manually(self, policy):
        
        with torch.no_grad():
            self.policynetwork.fc1.weight = torch.nn.Parameter(policy.policynetwork.fc1.weight)
            self.policynetwork.fc2.weight = torch.nn.Parameter(policy.policynetwork.fc2.weight)
